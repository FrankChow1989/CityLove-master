 ...
 * *****************************************
 */
public class FaceRelativeLayoutKeFu extends RelativeLayout implements
        OnItemClickListener, OnClickListener
{
    ...
    public FaceRelativeLayoutKeFu(Context context)
    {
        super(context);
        this.context = context;
    }

    public FaceRelativeLayoutKeFu(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.context = context;
    }

    public FaceRelativeLayoutKeFu(Context context, AttributeSet attrs, int defStyle)
    {
