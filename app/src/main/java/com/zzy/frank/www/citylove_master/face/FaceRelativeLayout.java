package com.zzy.frank.www.citylove_master.face;
        ...
        OnItemClickListener, OnClickListener
{
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.kefu_chat_face:
                ...
                if (view_extend.getVisibility() == View.VISIBLE)
                {
                    view_extend.setVisibility(View.GONE);
            ...
            case R.id.id_extend_img:
                ...
                {
                    view_extend.setVisibility(VISIBLE);
                    InputMethodManager imm = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
                    imm.hideSoftInputFromWindow(et_sendmessage.getWindowToken(), 0);
                }
                ...
                {
                    view.setVisibility(View.GONE);
                    view_extend.setVisibility(View.VISIBLE);
            ...
            case R.id.chat_bottom_pic_have:
                break;

            case R.id.chat_bottom_carmera_have:
                break;
        }
    }
    ...
    private void Init_View()
    {
        ...
        findViewById(R.id.kefu_chat_face).setOnClickListener(this);
        findViewById(R.id.id_extend_img).setOnClickListener(this);
        view = findViewById(R.id.ll_facechoose);
        view_extend = findViewById(R.id.ll_extendchoose);
        findViewById(R.id.chat_bottom_pic_have).setOnClickListener(this);
        findViewById(R.id.chat_bottom_carmera_have).setOnClickListener(this);
    }
