...
public class UserDB
{
    ...
    public void addUser(List<User> list)
    {
        ...
        {
            db.execSQL(
                    "insert into user (userId,nick,lastmsg,img,channelId,_group) values(?,?,?,?,?,?)",
                    new Object[]{u.getUserId(), u.getNick(), u.getLastMSG(), u.getHeadIcon(),
    ...
    public void update(User u)
    {
        SQLiteDatabase db = helper.getWritableDatabase();
        db.execSQL(
                "update user set nick=?,lastmsg=?,img=?,_group=? where userId=?",
                new Object[]{u.getNick(), u.getLastMSG(), u.getHeadIcon(), u.getGroup(),
                        u.getUserId()});
        db.close();
    }
